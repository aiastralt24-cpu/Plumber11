export default function AboutPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <p className="text-sm font-semibold uppercase tracking-[0.24em] text-teal">About</p>
      ...
      <div className="mt-8 space-y-5 text-lg leading-8 text-muted">
        ...
        <p>
          Phase 1 focuses on 8 launch cities, 91 live pages, CRM-backed response discipline, and a
          content system that scales city expansion without code changes.
        </p>
      </div>
    </main>
  );
